 ...
 * 
 */
public class MyVerticaRecord implements Writable {
	...
	public MyVerticaRecord(Configuration conf,Text outTable) 
		throws ClassNotFoundException, SQLException, IOException {
		Connection conn = MyVerticaConfiguration.getConnection(conf, true);
		Relation vTable = new Relation(outTable.toString());
	 ...
	 * @throws SQLException
	*/
	public MyVerticaRecord(ResultSet results) throws SQLException {
