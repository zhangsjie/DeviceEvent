...
public class VerticaRecordReader extends
    RecordReader<LongWritable, VerticaRecord1> {
	...
	public void initialize(InputSplit split, TaskAttemptContext context)
		...
		try {
			pos++;
			value = new VerticaRecord1(results);
	...
	@Override
	public VerticaRecord1 getCurrentValue() throws IOException,
