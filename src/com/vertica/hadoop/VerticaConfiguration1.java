 ...
 * {@link VerticaInputFormat}, and {@link VerticaOutputFormat1}. Alternatively,
 ...
 * @see VerticaConfiguration1#configureVertica(Configuration, String[], String,
 ...
 * @see VerticaInputFormat#setInput(Job, String, String...)
 * @see VerticaOutputFormat1#setOutput(Job, String)
 * @see VerticaOutputFormat#setOutput(Job, String, Collection<VerticaTable>)
 * @see VerticaOutputFormat1#setOutput(Job, String, boolean)
 * @see VerticaOutputFormat1#setOutput(Job, String, boolean, String...)
 */
public class VerticaConfiguration1 {
	...
	/** Output table names  */
	public static final String OUTPUT_TABLE_NAME_PROPS = "mapred.vertica.output.table.names";
	/**
	...
	public VerticaConfiguration1(Configuration conf) {
		this.conf = conf;
	}
	...
	/**
	  ...
	  * @throws SQLException
	  */
	public synchronized Connection getConnection(boolean output) throws IOException,
		...
		if (query_params != null) {
			...
			for (String str_params : query_params) {
				...
				for (int count = 0; count < sz; count++) {
					int type = in.readInt();
					params.add(VerticaRecord1.readField(type, in));
				}
				values.add(params);
			}
		}
	...
	*/
		...
		throws IOException 
	{
		...
		for (List<Object> params : segment_params) {
			...
			{
				int type = VerticaRecord1.getType(obj);
				out.writeInt(type);
				VerticaRecord1.write(obj, type, out);
			}
	 ...
	 * Get the table that is the target of output
	 * 
	 * @return Returns table names for output
	 */
	public String[] getOutputTableNames() {
		return conf.getStrings(OUTPUT_TABLE_NAME_PROPS);
	}
	 ...
	 * @param tableName
	 */
	public void setOutputTableNames(String tableNames) {
		conf.setStrings(OUTPUT_TABLE_NAME_PROPS, tableNames);
	}
